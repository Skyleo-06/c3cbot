    ...
    scope: function (type, data) {
      ...
      if (isNaN(parseInt(data.args[1])) && data.args.length != 1) {
        ...
        if (type == "Discord") {
          ...
          var info1234 = ["[Bạn có biết?]: Bạn chưa biết gì cả.", "[Bạn có biết?]: Bạn đã biết.", "[Bạn có biết?]: Đừng bao giờ mong chờ điều gì ở C3CBot.", "[Bạn có biết?]: Sẽ rất là không hay nếu làm Nghĩa (SpermLord) cáu... Đừng cố thử nhé.", "[Bạn có biết?]: Ngôn ngữ của Nobicunt là ngôn ngữ của Chúa.", "[Bạn có biết?]: Chúng tôi có Nobicunt từ v1 đến v4.", "[Bạn có biết?]: Nếu bạn gặp 1 người có tên là Nobi Kun, hãy tránh xa người đó càng nhiều càng tốt. Nếu không, cả gia phả nhà người đó sẽ đến ám bạn suốt đời, con cháu bạn sẽ bị ám bởi cái tên Nobicunt.", "[Bạn có biết?]: Đây không phải là bot Mirai hay KB2A.", "[Bạn có biết?]: Đây là con bot tự viết code cho chính nó.", "[Bạn có biết?]: Đây là 1 lệnh vô dụng.", "[Bạn có biết?]: 228922 là một con số tuyệt vời.", "[Bạn có biết?]: 177013 là một con số tuyệt vời.", "[Bạn có biết?]: C3CBot không có khả năng hiểu được Nobicunt.", "[Bạn có biết?]: C3CBot không có khả năng hiểu được phụ nữ."];
          var info12345 = ["​"];
